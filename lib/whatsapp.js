...
class Message_was extends AsyncConstructor {
    constructor(client, message) {
        super(async () => {
            ...
            if (check !== "Command-reject" && check !== "Video-reject" && check !== "Url-Reject" && check !== "Video-Url-Reject" && check !== "Url-No-Detected" && check !== "Sticker") {
    ...
    async checkMessage() {
        ...
        } else if (this.message.type === "sticker") {
            return "Sticker";
        }
    }
